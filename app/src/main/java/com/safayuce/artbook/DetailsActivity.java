...
import com.safayuce.artbook.databinding.ActivityDetailsBinding;
import com.safayuce.artbook.databinding.ActivityMainBinding;
...
public class DetailsActivity extends AppCompatActivity {
    ...
    ActivityResultLauncher<String> permissionLauncher;// izin alamak için
                       ...
                       //binding.imageView.setImageURI(imageData);
                        ...
                        try {
                            ...
                            if(Build.VERSION.SDK_INT>=28) {
                                //bu komutu kullamabilmek için api 28 ve üstü olması gerekir if sorgusu bu yüzden yap
